...
function Chords (){
    ...
    const drawChords = (root, suf) => {
        ...
        if (root == "Todos"){
            ...
            try {
                divi =  <div className="acordes">   
                {
                    listChord.positions.map((chord, index) => 
                        {
                            return  <div className="acorde">
                                        <b>{listChord.key + listChord.suffix + " v"+ (index+1).toString()}</b>
                                        <Chord
                                                chord={chord}
                                                instrument={instrument}
                                                lite={lite}
                ...
                divi = <div className ="acordes"><p>{"No se encontraron coincidencias :("}</p></div>
            }
                    ...
                    <Row>
                        ...
                        <Col md={10}>
                            {loaded ? (
                                ...
                                <ReactLoading type={"spinningBubbles"} color={"#2f8bd6"} height={'20%'} width={'20%'} className="spin"/>
                                )}
                        </Col>
                    </Row>
            </Container>
